...
const App = () => {
  ...
  return (
    <div>
      <h1>give feedback</h1>
      <Button handleClicks={() => setGood(good + 1)} text={stats.names[0]} />
      <Button handleClicks={() => setNeutral(neutral + 1)} text={stats.names[1]} />
      <Button handleClicks={() => setBad(bad + 1)} text={stats.names[2]} />
      <h1>statistics</h1>
